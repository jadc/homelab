                ...
                hooks = {
                    fcm = {
                        ...
                        pass-arguments-to-command = [
                            ...
                            { source = "string"; name = "WEBHOOK=${inputs.secrets}/webhook UV_PYTHON_PREFERENCE=only-system printf '%s\\0' \"$0\" | xargs -0 ${pkgs.uv}/bin/uv run ${toString ./config/script/fcm/fcm.py} >> /var/log/fcm.log 2>&1"; }
